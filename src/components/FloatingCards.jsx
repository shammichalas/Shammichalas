...
const cardsData = [
  { 
    ...
    icon: (
      <svg className="w-5 h-5 text-neutral-400 opacity-80" viewBox="-11.5 -10.23174 23 20.46348" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  { 
    ...
    glow: 'rgba(255, 255, 255, 0.05)',
    icon: (
      <svg className="w-5 h-5 text-neutral-400 opacity-80" viewBox="0 0 180 180" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  { 
    ...
    glow: 'rgba(255, 255, 255, 0.05)',
    icon: (
      <svg className="w-5 h-5 text-neutral-400 opacity-80" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        return (
          ...
          >
            ...
            <div 
              ...
              className="glass-panel px-4 py-3 rounded-2xl flex items-center gap-3 select-none card-border-glow group transition-all duration-700 bg-neutral-900/40 backdrop-blur-md border border-white/5 shadow-xl"
            >
              {/* Technology Icon Wrapper */}
              <div 
                className="w-9 h-9 rounded-xl flex items-center justify-center bg-neutral-900/60 border border-white/5 group-hover:scale-105 group-hover:border-neutral-400/30 group-hover:bg-neutral-800 transition-all duration-500 shadow-inner"
              >
                {card.icon}
              </div>
              ...
              <div className="flex flex-col">
                <span className="font-display text-[11px] tracking-wider text-neutral-400 font-bold uppercase transition-colors duration-500 group-hover:text-neutral-200">
                  TECH NODE
                </span>
                <span className="font-sans text-xs font-bold text-neutral-200 group-hover:text-white transition-colors duration-500">
                  {card.name}
                </span>
              </div>
